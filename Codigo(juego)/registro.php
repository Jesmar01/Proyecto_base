		...
		<div class="row">
         ...
         <center>
            ...
            <label for="usuario">Usuario</label>
                 ...
                 <input type="password"  name="confirmar_contrasena" placeholder="Contraseña" required>
                 <br>
...
/**/$enlace = new mysqli('localhost', 'root','',  'bd_juegos');//'app' nombre de la bd
  ...
  if (isset($_POST["bt_guardar"])) {
        ...
        echo $usuario;
        //insertar
        $campos = "usuario,  contrasena, confirmar_contrasena"; //son los valores que esan en bd
        $valores = "'$usuario','$contrasena', '$confirmar_contrasena'"  ; 

        if (!$enlace->query( "INSERT INTO   registros ($campos) values ($valores)" )) {
